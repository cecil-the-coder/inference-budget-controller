...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileDownloadStatus) DeepCopyInto(out *FileDownloadStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileDownloadStatus.
func (in *FileDownloadStatus) DeepCopy() *FileDownloadStatus {
	if in == nil {
		return nil
	}
	out := new(FileDownloadStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InferenceModelStatus) DeepCopyInto(out *InferenceModelStatus) {
	*out = *in
	if in.DownloadFiles != nil {
		in, out := &in.DownloadFiles, &out.DownloadFiles
		*out = make([]FileDownloadStatus, len(*in))
		copy(*out, *in)
	}
	if in.DownloadStartedAt != nil {
		in, out := &in.DownloadStartedAt, &out.DownloadStartedAt
		*out = (*in).DeepCopy()
	}
	if in.DownloadCompletedAt != nil {
		in, out := &in.DownloadCompletedAt, &out.DownloadCompletedAt
		*out = (*in).DeepCopy()
	}
